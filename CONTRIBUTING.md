...
multiple random seeds. They do not require downloads, large external data
sets, special platforms, or manual inspection of generated artefacts. On a
typical development machine, the current extended test adds only a few
seconds to the test run.
