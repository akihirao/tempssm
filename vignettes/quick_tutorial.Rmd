...
```{r message = FALSE, warning = FALSE, echo = TRUE}
res_baba_without_ar1 <- lgssm(baba_temp_ts,ar_order=1) 
summary(res_baba_without_ar1)
res_baba_without_ar1_AIC <- extract_AIC(res_baba_without_ar1)
plot(res_baba_without_ar1)

res_baba_without_ar2 <- lgssm(baba_temp_ts,ar_order=2) 
summary(res_baba_without_ar2)
res_baba_without_ar2_AIC <- extract_AIC(res_baba_without_ar2)
plot(res_baba_without_ar2)

res_baba_without_ar3 <- lgssm(baba_temp_ts,ar_order=3) 
summary(res_baba_without_ar3)
res_baba_without_ar3_AIC <- extract_AIC(res_baba_without_ar3)
plot(res_baba_without_ar3)
...
```{r message = FALSE, warning = FALSE, echo = TRUE}
res_baba_with_ar1 <- lgssm(temp_data=baba_temp_ts,
                           exo_data=baba_exo_ts,
                           ar_order = 1) 
summary(res_baba_with_ar1)
res_baba_with_ar1_AIC <- extract_AIC(res_baba_with_ar1)
plot(res_baba_with_ar1)

res_baba_with_ar2 <- lgssm(temp_data=baba_temp_ts,
                           exo_data=baba_exo_ts,
                           ar_order = 2) 
summary(res_baba_with_ar2)
res_baba_with_ar2_AIC <- extract_AIC(res_baba_with_ar2)
plot(res_baba_with_ar2)

res_baba_with_ar3 <- lgssm(temp_data=baba_temp_ts,
                           exo_data=baba_exo_ts,
                           ar_order = 3) 
summary(res_baba_with_ar3)
res_baba_with_ar3_AIC <- extract_AIC(res_baba_with_ar3)
plot(res_baba_with_ar3)
```
...
models_AICs <- tibble(
  ...
  AIC=c(
    res_baba_without_ar1_AIC,
    res_baba_without_ar2_AIC,
    res_baba_without_ar3_AIC,
    res_baba_with_ar1_AIC,
    res_baba_with_ar2_AIC,
    res_baba_with_ar3_AIC
  )
)
...
res_MtAkadake <- lgssm(MtAkadake_ts, ar_order=1)
...
# Perform linear Gaussian state-space modelling with AR1
res_ibaraki_sst_ar1 <- lgssm(monthly_ibaraki_sst_ts,ar_order = 1)
summary(res_ibaraki_sst_ar1)
plot(res_ibaraki_sst_ar1)

# Perform linear Gaussian state-space modelling with AR2
res_ibaraki_sst_ar2 <- lgssm(monthly_ibaraki_sst_ts,ar_order = 2)
summary(res_ibaraki_sst_ar2)
plot(res_ibaraki_sst_ar2)

# Perform linear Gaussian state-space modelling with AR3
res_ibaraki_sst_ar3 <- lgssm(monthly_ibaraki_sst_ts,ar_order = 3)
summary(res_ibaraki_sst_ar3)
plot(res_ibaraki_sst_ar3)

# Perform linear Gaussian state-space modelling with AR4
res_ibaraki_sst_ar4 <- lgssm(monthly_ibaraki_sst_ts,ar_order = 4)
summary(res_ibaraki_sst_ar4)
plot(res_ibaraki_sst_ar4)
```
