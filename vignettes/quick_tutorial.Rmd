...
```{r message = FALSE, warning = FALSE, echo = TRUE}
plt_level_without_ts <- tempssm::autoplot(res_without,
                                 component=c("level")
                                 ) +
  labs(title="Model without the PDO index") +
  theme_classic()

plt_drift_without_ts <- tempssm::autoplot(res_without, 
                             component=c("drift")
                             ) + 
  labs(title="Model without the PDO index") +
  theme_classic()
...
plt_level_with_ts <- tempssm::autoplot(res_with,
                          component=c("level")
                          )+ 
  labs(title="Model with the PDO index") +
  theme_classic()

plt_drift_with_ts <- tempssm::autoplot(res_with,
                          component=c("drift")
                          ) + 
  labs(title="Model with the PDO index") + 
  theme_classic()
