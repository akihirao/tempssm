...
```
The dataset includes no missing observations. Even if missing observations was included, 
there are retained and handled explicitly within the state-space modeling framework.
