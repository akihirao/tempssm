...
#' @srrstatsTODO {TS5.4} *For frequency visualization, abscissa spanning
#' negative to positive pi should be avoided in favour of positive units from
#' zero to two pi or from zero to one-half, in all cases with appropriate
