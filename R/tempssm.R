...
#' summary(res)
#' }
tempssm <- function(temp_data,exo_data = NULL,
                ar_order = 1,
                use_seasonal = TRUE,
                inits = NULL,
                maxit = NULL,
  ...
  if(use_seasonal){
    out <- tempssm_season(temp_data=temp_data,
                      exo_data=exo_data,
                      ar_order = ar_order,
                      inits = inits,
                      maxit = maxit,
    ...
    out <- tempssm_no_season(temp_data=temp_data,
                         exo_data=exo_data,
                         ar_order = ar_order,
                         inits = inits,
                         maxit = maxit,
...
#' \dontrun{
#' data(niigata_sst)
#' res <- tempssm_seasonal(niigata_sst)
#' summary(res)
#' }
tempssm_season <- function(temp_data,
                       exo_data = NULL,
                       ar_order = 1,
                       inits = NULL,
                       maxit = NULL,
...
#' \dontrun{
#' data(niigata_sst)
#' res <- tempssm_no_season(niigata_sst)
#' summary(res)
#' }
tempssm_no_season <- function(temp_data,
                          exo_data = NULL,
                          ar_order = 1,
                          inits = NULL,
                          maxit = NULL,
